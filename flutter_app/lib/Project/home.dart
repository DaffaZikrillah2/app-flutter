...
class _HomePageUtsState extends State<HomePageUts> {
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Card(context, 'biji.png', 'Batik Pria Lengan Panjang', 'Rp199.900'),
            SizedBox(width: 16),
            Card(context, 'assets/Rectangle 4 (1).png',
                'New Balance 992 Grey Original', 'Rp1.240.000'),
          ],
        ),
        SizedBox(height: 24),
        Row(
          ...
          children: [
            ...
            Card(context, 'assets/Rectangle 4 (3).png',
                'Kacamata Baca Anti Radiasi Blue Ray', 'Rp125.000'),
          ],
        ),
        SizedBox(height: 24),
        Row(
          ...
          children: [
            Card(context, 'assets/Rectangle 4 (4).png',
                'Kemeja Pria Polos Lengan Pendek Oxford', 'Rp119.000'),
            SizedBox(width: 16),
  ...
  Widget Card(context, String img, String judul, String harga) {
    final screenWidth = MediaQuery.of(context).size.width;
  ...
  Row _Header(double screenWidth) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Container(
